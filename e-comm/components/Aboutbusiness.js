...
function Aboutbusiness() {
  return (
    <div>
       <section className="text-gray-600 body-font p-8 ">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="p-4 md:w-1/2 shadow-md xl:w-1/3 shadow-gray-500 ">
        <div className="flex rounded-lg h-full bg-yellow-100 p-8 flex-col">
          ...
          <div className="flex-grow">
            <p className="leading-relaxed text-base text-center">Learn the art of using Google Ads to scale your business beyond your local limits & 3x your current profit.</p>
            <p className="leading-relaxed text-base text-center">Attend the workshop to know how to run profitable campaigns that get you high return on your investment (ROI).</p>
      ...
      <div className="p-4 md:w-1/2 shadow-md shadow-gray-500 xl:w-1/3">
        <div className="flex rounded-lg h-full bg-yellow-100 p-8 flex-col">
          ...
          <div className="flex-grow">
           ...
           <p className="leading-relaxed text-base text-center">Learn how to run Google Ads and scale any business from the comfort of your home.</p>
          </div>
