...
function Banner() {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="  lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <h1 className="  sm:text-4xl text-sm mb-4 font-thin text-yellow-500">Master Google Ads - #1 Skill in Digital Marketing</h1>
      ...
      <h1 className="  sm:text-4xl text-sm mb-4 font-thin text-yellow-500">Learn Google Ads from Visiting Faculty at NMIMS with over 8 years of exp running google ads.</h1>
      ...
      <h1 className="  sm:text-4xl text-sm mb-4 font-thin text-yellow-500">Use Google Ads to scale businesses & drive exponential profits</h1>
      <p className="mb-8 text-white">Use Google Ads to take any business to the next level. Reach the right audience at the right time to 3x profits with high ROI driven ads.</p>

      <h1 className="  sm:text-4xl text-sm mb-4 font-thin text-yellow-500">Land high paying clients as a Google Ads Consultant</h1>
