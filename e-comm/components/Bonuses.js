    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="p-4 md:w-1/3">
        <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          ...
          <h2 className="text-yellow-500 text-lg text-center space-x-6 p-4 w-[180px] title-font font-medium border bg-black">Bonus-2</h2>
          </div>
          <div className="flex-grow">
            <p className="leading-relaxed text-base text-center">10 Foolproof Copywriting Tips for Google Ads</p>
            <p className="leading-relaxed text-base text-center border border-black">Worth Rs 4,000</p>
      ...
      <div className="p-4 md:w-1/3">
        <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          ...
          <h2 className="text-yellow-500 text-lg text-center space-x-6 p-4 w-[180px] title-font font-medium border bg-black">Bonus-3</h2>
          </div>
          <div className="flex-grow">
            <p className="leading-relaxed text-base text-center">10 Secret Hacks to 10X Your Google Ads ROI</p>

            <p className="leading-relaxed text-base text-center border border-black">Worth Rs 5,000</p>
      ...
      <div className="p-4 md:w-1/3">
        <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          ...
          <h2 className="text-yellow-500 text-lg text-center space-x-6 p-4 w-[180px] title-font font-medium border bg-black">Bonus-5</h2>
          </div>
          <div className="flex-grow">
            <p className="leading-relaxed text-base text-center">Step by Step Google Ads Launch Checklist</p>
            <p className="leading-relaxed text-base text-center border border-black">worth 4,000</p>
